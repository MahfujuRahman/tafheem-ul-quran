<header class="tq-bg-secondary tq-bg-blend-screen back-pos-cntr-norpet tq-style2 w-100"
    style="background-image: url(../frontend/uploads/2023/11/tq-pattern2.png); height: 100px">
    <div class="container">
            ...
            <div class="row">
                <div class="col-md-5 col-sm-12 col-lg-5">
                    <div class="tq-header-inner d-flex flex-column position-relative w-100">
                        <div
                            ...
                            <nav>
                                <ul id="menu-short-menu" class="">
                                    <li
                                        class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-2700">
                                    ...
                                    <li id="menu-item-3469"
                                        ...
                                        <a href="../travel-tours/index.html">Tours</a>
                                    </li>
                                    <li id="menu-item-3470"
                ...
                <div class="col-md-2 col-sm-12 col-lg-2">
                    <div class="tq-logo position-relative w-100">
                        <a href="../index.html"><svg class="fill-theme" xmlns="http://www.w3.org/2000/svg"
                            ...
                            </svg><img src="../frontend/uploads/2024/01/logo-insignia.png" alt=""
                                loading="lazy"></a>
                    </div><!-- Logo -->
                </div>
                <div class="col-md-5 col-sm-12 col-lg-5">
    ...
    <div class="tq-res-topbar w-100">
        <div class="container">
            <div class="tq-res-topbar-inner d-flex flex-wrap align-items-center justify-content-between w-100">
                <div class="tq-logo position-relative w-100">
                    <a href="../index.html">
                        <svg class="fill-theme" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 184.15 191.11">
                            <g>
                                <path d="M93.08,191.11c-0.33,0-0.67,0-1,0c-5.44-8.58-13.89-13.21-22.85-16.97c-9.31-3.91-17.25-9.39-22.27-18.33
                                c-1.76-3.14-3.91-4.36-7.49-4.54C27.15,150.68,20,144.64,17,132.6c-0.51-2.04-1.41-3.36-3.43-3.73c-5.72-1.05-9.92-4.41-13.5-8.75
                                C0.08,81.49,0.12,42.87,0,4.25C-0.01,1.13,0.22-0.01,3.93,0c58.76,0.16,117.53,0.16,176.29,0c3.71-0.01,3.94,1.13,3.93,4.25
                        ...
                        <img width="216" height="102" src="../frontend/themes/taqwa/assets/images/logo2.png"
                            alt="Muezzin" itemprop="image">
                    </a>
                </div><!-- Logo -->
                ...
                <ul class="sub-menu">
                    <li id="menu-item-707"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-707"><a
                            href="../our-campaigns/index.html">Our Campaigns</a></li>
                    <li id="menu-item-783"
                        class="menu-item menu-item-type-post_type menu-item-object-campaign menu-item-783"><a
                            href="../campaigns/educate-rural-kenya/index.html">Campaign Details</a></li>
                </ul>
            </li>
            <li id="menu-item-724"
                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-724"><a
                    href="#">Events</a>
                <ul class="sub-menu">
                    <li id="menu-item-723"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-723"><a
                            href="../upcoming-events/index.html">Our Events</a></li>
                    <li id="menu-item-2038"
                        class="menu-item menu-item-type-post_type menu-item-object-event menu-item-2038"><a
                            href="../events/intl-hajj-program-offers/index.html">Intl. Hajj Program Offers</a></li>
                </ul>
            </li>
            <li id="menu-item-630"
                ...
                <ul class="sub-menu">
                    <li id="menu-item-671"
                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-671"><a
                            href="../islamic-scholars/index.html">Islamic Scholars</a></li>
                    <li id="menu-item-796"
                        class="menu-item menu-item-type-post_type menu-item-object-team menu-item-796"><a
                            href="../team/sharif-hammam/index.html">Scholar Profile</a></li>
                </ul>
            </li>
            <li id="menu-item-628"
                        ...
                        <ul class="sub-menu">
                            <li id="menu-item-673"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-673"><a
                                    href="../offered-services/index.html">Offered Services</a></li>
                            <li id="menu-item-801"
                                class="menu-item menu-item-type-post_type menu-item-object-services menu-item-801"><a
                                    href="../services/hajj-umrah/index.html">Service Details</a></li>
                        </ul>
                    </li>
                    <li id="menu-item-689"
