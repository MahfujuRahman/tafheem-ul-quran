            ...
            <div class="tq-footer-body position-relative w-100">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-lg-4 order-lg-1">
                        <div class="tq-widget-box d-flex flex-column align-items-center position-relative w-100">
                            <div class="tq-logo v2 mb-0 position-relative w-100"><a href="../index.html"
                                    title=""><svg class="fill-theme" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 184 281">
                                        <g>
                                            <path
                        ...
                        <div class="widget-box widget style2 widget">
                            ...
                            <div class="tq-widget-box d-flex flex-column position-relative w-100">
                                ...
                                <p class="mb-0">Elit duis volutpat ligula nulla a getmolestie mi consectetur auctor
                                    ugue ac tincidunt, varius felis et,augue lorem. Aliqu am accum san frin it duis
                                    volutpat ligilla.
                                </p>
                            </div>
                            <div class="tq-social-links text-white d-inline-flex align-items-center"><a
                                    href="https://twitter.com/" title="Twitter" itemprop="url" target="_blank"><i
                                        class="fab fa-twitter"></i></a><a href="https://facebook.com/" title="Facebook"
                                    itemprop="url" target="_blank"><i class="fab fa-facebook-f"></i></a><a
                                    href="https://linkedin.com/" title="Linkedin" itemprop="url" target="_blank"><i
                                        class="fab fa-linkedin-in"></i></a><a href="https://instagram.com/"
                                    title="Instagram" itemprop="url" target="_blank"><i class="fa fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
...
c-1.75,1.47-3.59,2.83-5.41,4.22c-4.32,3.3-8.65,6.59-12.96,9.9C59.86,59.57,55.28,61.16,50.23,61.2z" />
                                        ...
                                        </i><a href="mailto:username@domain.com" title="">username@domain.com</a>
                                    </li>
                                    <li><i
                                            class="tq-bg-theme d-inline-flex align-items-center justify-content-center rounded-circle">
...
c1.92,0.02,3.63-1.67,3.65-3.61C53.62,33.99,51.94,32.29,50,32.27z">
            ...
            <div class="tq-footer-bottom d-flex align-items-center justify-content-center position-relative w-100">
